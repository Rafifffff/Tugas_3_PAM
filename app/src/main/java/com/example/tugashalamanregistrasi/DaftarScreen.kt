...
@Composable
fun DaftarScreen(onDaftar: (String, String, String, String) -> Unit) {
    ...
    Column(
        ...
        Text("Halaman Registrasi", color = Color(0xFF4CAF50), style = MaterialTheme.typography.headlineSmall)
        ...
        Spacer(Modifier.height(16.dp))
        Button(
            onClick = { onDaftar(nim, nama, email, password) },
